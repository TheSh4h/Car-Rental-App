...
const CarCard = ({ car }) => {
  return (
    <div className="bg-white rounded overflow-hidden shadow-md w-72 border-slate-500 border-[1px]">
      <img src={`/image/${car.image}`} alt={car.name} className="w-full h-64 object-fill object-center" />
