const Footer = () => {
    return ( 
        <div className="bg-white py-20 text-center md:text-start md:flex justify-evenly">
            <ul className="my-10">
                <li className="text-2xl"> 
                    <span className="font-bold">CAR</span> Rental
                </li>
                <li className="text-[#706f7b] w-72 mx-auto md:mx-0">We offers a big range of vehicles for all your driving needs. We have the perfect car to meet your needs.</li>
                <li>
            ...
            <ul className="my-10">
                ...
                <li className="font-semibold w-56 mx-auto md:mx-0">Subscribe to out email list for latest news and updates</li>
                <li>
